...
\posgrado{Maestría en comptación de borde} 
...
\pertenenciaCoDirector{Universidad Nacional del Sur}
...
Colaborador       & Javier Roberts      &\empclientename	&        -	\\ \hline
...
El proyecto incluye:
\begin{itemize}
	\item Relevamientos detallado de los requerimientos del cliente.
	...
	\item Pruebas funcionales y de integración.
...
\begin{itemize}
	\item Se dispondrá con la suficiente cantidad de videos para el correcto procesamiento e identificación de eventos..
		...
		\begin{enumerate}
			\item El modelo deberá reconocer 6 posibles estados del quirófano:
					\begin{enumerate}
						...
						\item Otro
					\end{enumerate}
			\item El estado registrado deberá ser guardado en una base de datos
			\item El usuario debe poder ejecutar el modelo sobre un video.
			\item La solución propuesta deberá indicar el grado de confianza de la detección y el error
			esperado en las mediciones.
		\end{enumerate}
...
\begin{itemize}
	\item Usuario administrativo: personal del hospital responsable de administrar el uso del quirófano. 
	\item Administrador del sistema: responsable de la ejecución y monitoreo de los modelos y sistemas.
	\item Jefe de tecnología de Wúru: responsable por el correcto funcionamiento de la aplicación y su integración con los demás sistemas hospitalarios.
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Ponderación final: 13 story points
	\end{itemize}
\end{itemize}

\begin{itemize}
	\item Como administrador del sistema debo de poder monitorear la efectividad del modelo como así también la performance del sistema.
	\begin{itemize}
		\item Cantidad de trabajo a realizar: 5
		\item Complejidad del trabajo: 5
		\item Incertidumbre/riesgo: 5
		\item Ponderación final: 21 story points
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Ponderación final: 8 story points
	\end{itemize}
\end{itemize}
